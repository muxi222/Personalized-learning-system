"""
Feedback stats - XMX module (学生实现)
...
async def get_feedback_stats(
    ...
    """
    TODO: 统计 XMX 模块（economics）的反馈情况
    """
    if subject and subject not in settings.SUBJECTS:
        raise HTTPException(status_code=400, detail=f"Subject '{subject}' is not supported by xmx. Supported: {settings.SUBJECTS}")
    raise HTTPException(status_code=501, detail="TODO: Implement feedback stats in XMX module")
