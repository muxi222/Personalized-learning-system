...
async def chat(
    ...
    if not await _personal_model_should_run(svc, trace_id):
        raise HTTPException(
            ...
            detail=(
                ...
                "  PERSONAL_MODEL_API_BASE_WZM=http://127.0.0.1:8004/v1\n"
                "  PERSONAL_MODEL_MODEL_WZM=wzm-qwen3-14b\n"
                "Then (re)start vLLM by: ./deploy/scripts/pipeline.sh serve-model --module wzm up\n"
    ...
    try:
        ...
        logger.info(
            ...
            trace_id,
            os.environ.get("PERSONAL_MODEL_API_BASE_WZM") or "http://127.0.0.1:8004/v1",
            svc.default_model,
            len(model_messages),
            len(retrieved),
        )
        ...
        raise HTTPException(
            ...
            detail=(
                ...
                "Try: curl http://127.0.0.1:8004/v1/models"
            ),
        )
