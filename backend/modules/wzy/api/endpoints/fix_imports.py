#!/usr/bin/env python3
"""
Batch fix imports for WZY module endpoints
"""
import os
import re
...
replacements = [
    ...
    (r'from \.\.\.\.core\.config import', 'from backend.modules.wzy.config import'),
    (r'from \.\.deps import', 'from backend.modules.wzy.api.deps import'),

    # 处理agents导入（需要指向模块的agents）
    (r'from \.\.\.\.agents\.', 'from backend.modules.wzy.agents.'),
]
