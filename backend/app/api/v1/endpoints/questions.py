...
from ....crud import crud_question, crud_task, crud_user
...
from ....services.gemini_ocr_service import get_gemini_ocr_service, SubjectType
from ....core.file_utils import get_user_upload_dir, get_user_file_url
...
async def create_question_with_image(
    ...
    from ....core.file_utils import calculate_file_hash, get_filename_from_path
