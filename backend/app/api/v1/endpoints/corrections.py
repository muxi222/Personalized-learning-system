...
from ....crud.crud_exam_correction import (
    get_exam_correction,
    get_exam_corrections,
    get_correction_statistics,
    delete_exam_correction,
)
from ....db.models import User, SubjectEnum
...
def image_to_url(correction_id: int, image_type: str) -> str:
    ...
    Returns:
        URL路径
    """
    # 生成URL: /api/v1/ocr/images/corrections/{correction_id}/{image_type}
    return f"/api/v1/ocr/images/corrections/{correction_id}/{image_type}"
