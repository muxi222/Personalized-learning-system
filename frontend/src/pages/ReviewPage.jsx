...
export default function ReviewPage() {
  const { data, isLoading } = useQuery({
    queryKey: ['review-due', 20],
    queryFn: () => questionApi.getDueForReview({ limit: 20 }),
  })
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1 min-w-0">
                  ...
                  <div className="flex items-center gap-3 flex-wrap">
                    ...
                    <span className={clsx(
                      'badge',
                      question.mastery_level < 0.3 && 'bg-red-500/20 text-red-300 border border-red-500/30',
                      question.mastery_level >= 0.3 && question.mastery_level < 0.7 && 'bg-amber-500/20 text-amber-300 border border-amber-500/30',
                      question.mastery_level >= 0.7 && 'bg-emerald-500/20 text-emerald-300 border border-emerald-500/30',
                    )}>
