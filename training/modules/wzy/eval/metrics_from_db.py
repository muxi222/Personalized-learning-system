...
# Example: python training/modules/wzy/eval/metrics_from_db.py --module wzy
...
async def compute_metrics(*, module: str = "wzy") -> Dict[str, Any]:
...
def main() -> None:
    ...
    p.add_argument("--module", default="wzy")
