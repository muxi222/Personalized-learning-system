#!/usr/bin/env python3
"""
WZM model eval runner (OpenAI-compatible endpoint).
...
def main() -> int:
    ...
    data_eval = repo_root / "data" / "training" / "wzm" / "eval"
    data_eval.mkdir(parents=True, exist_ok=True)
    eval_set = data_eval / "model_eval.jsonl"
    if not eval_set.exists():
        src = repo_root / "training" / "modules" / "wzm" / "eval" / "assets" / "model_eval_min.jsonl"
