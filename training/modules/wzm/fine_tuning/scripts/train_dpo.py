#!/usr/bin/env python3
"""
Wzm DPO runner wrapper.

Calls `training/core/fine_tuning/train_dpo.py` with wzm config.
"""
...
def main():
    parser = argparse.ArgumentParser(description="Wzm DPO runner (wrapper)")
    ...
    cfg = repo_root / "training" / "modules" / "wzm" / "fine_tuning" / "configs" / "dpo_qwen3_14b_lora.json"
